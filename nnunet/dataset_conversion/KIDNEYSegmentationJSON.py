...
if __name__ == "__main__":
    train_data_dir = "/src/mannheim/base/nnUNet_raw_splitted/Task00_DATASET/imagesTr"
    train_seg_dir = "/src/mannheim/base/nnUNet_raw_splitted/Task00_DATASET/labelsTr"
    test_dir = "/src/mannheim/base/nnUNet_raw_splitted/Task00_DATASET/imagesTs"


    output_folder = "/src/mannheim/base/nnUNet_raw_splitted/Task00_DATASET"
    ...
    nii_files_tr_data = subfiles(train_data_dir, True)
    nii_files_tr_seg = subfiles(train_seg_dir, True)

    nii_files_ts = subfiles(test_dir, True)
